...
export const metadata = { title: "Reports | Agency Portal" };
    ...
    <div className="min-h-screen bg-zinc-50 pb-28 md:pb-8">
      ...
      <main className="max-w-[1000px] mx-auto px-4 md:px-6 py-6">
        <div className="rounded-2xl border border-zinc-200 bg-white p-5">
          <h1 className="text-2xl font-semibold text-zinc-900">Reports & Analytics (Phase 2)</h1>
          <p className="text-sm text-zinc-500 mt-1">Request volume, response time trends, acceptance-rate slices, and exports will land here.</p>
        </div>
      </main>
    </div>
  );
