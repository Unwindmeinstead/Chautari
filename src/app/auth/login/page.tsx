    ...
    <div className="space-y-8">
      ...
      <div className="flex rounded-xl border border-forest-200 p-1 bg-forest-50 gap-1">
        <button
          ...
          className={`flex-1 py-2 px-3 rounded-lg text-sm font-medium transition-all duration-200 ${mode === "password"
        ...
        <button
          ...
          className={`flex-1 py-2 px-3 rounded-lg text-sm font-medium transition-all duration-200 ${mode === "magic"
              ? "bg-white text-forest-700 shadow-sm"
              : "text-forest-400 hover:text-forest-600"
            }`}
        >
